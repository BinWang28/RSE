...
from senteval.sts import (
    ...
    STS16Eval, 
    STSBenchmarkEval, 
    SICKRelatednessEval_unsup, 
    STSBenchmarkEval_unsup,
    STR,
    )
from senteval.sst import SSTEval
from senteval.rank import ImageCaptionRetrievalEval
from senteval.probing import *
from senteval.relpred import RelPredEval
...
class SE(object):
    def __init__(self, params, batcher, prepare=None):
        ...
        self.list_tasks = ['CR', 'MR', 'MPQA', 'SUBJ', 'SST2', 'SST5', 'TREC', 'MRPC',
                           ...
                           'SICKRelatedness_unsup', 'STSBenchmark_unsup', 'STR',
                           'SNLI', 'ImageCaptionRetrieval', 'STS12', 'STS13',
                           'STS14', 'STS15', 'STS16', 'RelPred',
    ...
    def eval(self, name):
        ...
        if name == 'CR':
        ...
        elif name == 'SICKRelatedness_unsup':
            self.evaluation = SICKRelatednessEval_unsup(tpath + '/downstream/SICK', seed=self.params.seed)
        elif name == 'STSBenchmark_unsup':
            self.evaluation = STSBenchmarkEval_unsup(tpath + '/downstream/STS/STSBenchmark', seed=self.params.seed)
        elif name == 'STR':
            self.evaluation = STR(tpath + '/downstream/STS/STR', seed=self.params.seed)
        elif name == 'SNLI':
            ...
            self.evaluation = RelPredEval(tpath + '/downstream/RELPRED', seed=self.params.seed)
